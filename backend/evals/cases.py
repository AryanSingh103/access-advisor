...
CASES = [
    ...
    dict(id="error_color_only", expected="3.3.1", also_acceptable=["1.4.1"],
         code='<input name="zip" class="error" style="border-color:red"><span style="color:red">!</span>'),
    dict(id="required_not_indicated", expected="3.3.2", also_acceptable=["1.3.1"],
         code='<form><input type="password" name="pw" required><button>Sign in</button></form>'),

    # --- 4.1.2 Name, Role, Value ---
    dict(id="fake_checkbox", expected="4.1.2", also_acceptable=["2.1.1"],
